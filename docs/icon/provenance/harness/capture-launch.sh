...
export DISPLAY=:211
export ALSOFT_CONF="/home/thomas/01_TM/Coding/Websites/brainage04.github.io/.local-icon-variants/round3/captures-teyvat/runtime/alsoft.conf"
export PULSE_SINK=round3_teyvat
export LIBGL_ALWAYS_SOFTWARE=1
export LP_NUM_THREADS=2
export MESA_GLTHREAD=false
export OMP_NUM_THREADS=2
exec /nix/store/b7hzgfqk2jfcbncp0vpabf73j0riqgq4-openjdk-25.0.4.1+1/bin/java "@/home/thomas/01_TM/Coding/Websites/brainage04.github.io/.local-icon-variants/round3/captures-teyvat/renders-dragonspine/capture-client.args"
